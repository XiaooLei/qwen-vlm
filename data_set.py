...
class LLaVADataset(Dataset):
    ...
    def __init__(self, data_dir: str = "./llava_data", is_train: bool = True, llm_name="Qwen/Qwen2.5-0.5B", vision_name="openai/clip-vit-large-patch14", sample_size: int = None):
        """
        初始化数据集加载器
